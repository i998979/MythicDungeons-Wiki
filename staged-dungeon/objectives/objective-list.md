...
| display    | Name of the mob displayed on scoreboard                                                                                                                            |                                                                                                                                                                                                                                                                                                    |          |
| type       | Entity types of the mob, seperate with spaces  , it follows the rule from [Spigot API](https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EntityType.html) |                                                                                                                                                                                                                                                                                                    |          |
