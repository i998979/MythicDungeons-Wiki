...
<summary><strong>With pre-built schematic</strong> (if you have a schematic file and want to use it)<strong>:</strong></summary>

* Join the server
* Place the schematic in world
...
<summary><strong>With all Dungeon Instances built in world:</strong></summary>
