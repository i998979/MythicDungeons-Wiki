...
MESSAGE_ROOM_ID_INVALID: "&cThe room's ID you have entered is invalid."
...
MESSAGE_ROOM_JOIN_ENTER_NAME_OR_ID: "&cPlease enter the room player's name or room ID that you want to join."
MESSAGE_ROOM_JOIN_NO_JOINED: "&c{0}&c is not in any room."
...
MESSAGE_GROUP_FILE_NOT_EXIST: "&cDungeon group file {0} does not exist."
MESSAGE_GROUP_LOADING: "&eLoading Dungeon group {0}..."
MESSAGE_GROUP_LOADED: "&aDungeon group {0} loaded from config."
MESSAGE_GROUP_LOAD_FAILED: "&cDungeon group {0} has failed to load. Please check console for errors."
MESSAGE_GROUPS_LOADING: "&eLoading Dungeon groups..."
...
MESSAGE_GROUP_MIGRATE_STILL_RUNNING: "&cDungeon groups cannot be migrated since there are dungeon still running."
...
MESSAGE_DUNGEON_NO_PERMISSION_JOIN_SELF: "&cYou don't have permission to join dungeon {0}&c."
...
# Stamina message
MESSAGE_DUNGEON_STAMINA_ENTER_NAME: "&cPlease enter player's name to modify the stamina."
...
MESSAGE_DUNGEON_STAMINA_UNDEFINED: "&cDungeon group {0} does not have stamina defined."
...
MESSAGE_DUNGEON_RELOADED_LOOTTABLE: "&eReloaded {0} loot tables."
MESSAGE_DUNGEON_RELOADED_SCOREBOARD: "&eReloaded scoreboard."
MESSAGE_DUNGEON_RELOADED_EFFECT: "&eReloaded {0} effects."
MESSAGE_DUNGEON_RELOADED_LANG: "&eReloaded language file."
MESSAGE_DUNGEON_RELOADED_CONFIG: "&eReloaded configuration."
MESSAGE_DUNGEON_RELOADED_MENU: "&eReloaded menu."
MESSAGE_DUNGEON_RELOADED: "&aMythicDungeons configuration has been reloaded."
...
MESSAGE_DUNGEON_FAIL_COMMAND: "&cDungeon challenge ended."
...
MESSAGE_DUNGEON_BUFF_CLAIMABLE: "&aBuff {0}&a is now claimable."
...
MESSAGE_DUNGEON_RESPAWN: "&aYou have respawned."
MESSAGE_DUNGEON_RESPAWN_SPAWN: "&aYou have respawned in dungeon's spawn."
...
SCOREBOARD_INGAME_NOT_INTERACTED: "&cNot interacted"
SCOREBOARD_INGAME_INTERACTED: "&aInteracted"
